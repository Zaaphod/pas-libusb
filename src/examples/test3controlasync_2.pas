...
const
     Seeduino_Lotus_VID= $10C4;
     Seeduino_Lotus_PID= $EA60;
     WHB04B_VID= $10CE;
     WHB04B_PID= $EB93;
...
Var Context   : TLibUsbContext;
    ...
    WHB04_Packet:Array [0..7] of byte;
  ...
  try
    ...
    try
      ...
      try
        ...
        Writeln('CT.wIndex        = $', inttohex(CT.wIndex,2));
        Writeln('CT.wLength       = $', inttohex(CT.wLength,2));
        Writeln('CT.Timeout       = $', inttohex(CT.Timeout,2));
        // setup callback
